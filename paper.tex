...
Our results show that we can predict the packet size distribution and inter-packet interval distribution of flows from only a handful of initial packets of each flow.
