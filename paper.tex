...
But it also provides evidence that the hypothesized model not only explains the observed linear structure, but is actually an accurate model of real network traffic.
\end{abstract}
