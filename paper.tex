...
We do not attempt to predict the exact number of packets in a specific flow.
Brief reflection shows that this cannot be done accurately:
flow behavior is not deterministic---many flows exhibit the same behavior initially but subsequently behave quite differently.
