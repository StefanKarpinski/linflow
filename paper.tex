...
\begin{align}
  \frac{1}{6}\parens{4\vec{e}_{40} + 2\vec{e}_{145}}.
\end{align}
...
Looking deeper than these immediate applications, however, the mere fact that this prediction technique works at all provides strong evidence that the underlying hypothesized model of flow behavior is valid.
Our future works will provide further applications and evidence by applying the same model to the problems of traffic classification and realistic workload generation.
...
The experimental methodology for testing this hypothesis is presented in \Section{methodology}, and the results follow in \Section{results}.
\Section{discussion} discusses the meaning and impact of our results.
\Section{related-work} gives context for this work in relation other research.
...
For training, we take a sample of network trace traffic and try to recover the structure hypothesized in \Section{hypothesis} from it.
