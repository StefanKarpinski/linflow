...
The predicted behavior for these flows is simply weight matrix times the predictable feature matrix:
\begin{align}
  X^*_\text{p} = W^* P_\text{p}.
\end{align}
The rows of $X^*_\text{p}$ are our prediction about the behavior of the flows observed in $X^*_\text{o}$.
