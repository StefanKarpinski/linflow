...
While understanding aggregate traffic behavior in core networks is certainly useful, we believe that an even broader application exists for the detailed individual flow behavior model we propose and provide evidence for here.
