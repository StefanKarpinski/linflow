...
We propose to view each flow as having a probability distribution of possible behaviors it could exhibit.
...
% \Equation{mixture-model} says that each of the distributions $q_i$ is a convex mixture of the 

% The question of why we see low-dimensional linear structure in the feature-frequency representation of network traffic is deeply connected to the nature of such linear representations themselves.
% But the answer to the question also requires us to posit a hypothesis about the nature of network traffic.
