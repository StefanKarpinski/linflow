...
The most fundamental tool in the investigation of linear structure in high dimensions is the singular value decomposition (\caps{SVD}).
This matrix decomposition can be applied to any real matrix and factors it into a product of three matrices:
\begin{align}
  X = US\trans{V}
\end{align}
where $U$ and $V$ are orthogonal and $S$ is diagonal, with entries of decreasing nonnegative value.
...
The rows of $US_k$ can thus be viewed as an optimal $k$-dimensional simplification of the rows of $X$ in the new coordinate system given by the columns of $V$.

\begin{figure}[!b]
\vspace{0.5em}
\begin{center}
\subfloat[IETF 60]{\includegraphics[width=1.6in]{svd/ie60}}
\subfloat[IETF 67]{\includegraphics[width=1.6in]{svd/ie67}}
\subfloat[SIGCOMM 2004]{\includegraphics[width=1.6in]{svd/sc04}}
\subfloat[UCSD]{\includegraphics[width=1.6in]{svd/ucsd}}
...
% The most direct way to demonstrate the motivating insight of this research is with pictures.
