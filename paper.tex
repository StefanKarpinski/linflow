...
Our methodology for recovering the hypothesized linear structure of network traffic from trace samples uses a variety of cutting-edge and recently developed data-mining techniques.
To extract linear subspace structure, we use Ma~\emph{et~al.}'s 2007 algorithm based on lossy compression of data points~\cite{Ma07}.
