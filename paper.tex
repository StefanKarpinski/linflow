...
As better point-measure of the quality of predictors, we propose the maximum vertical distance between its p-value \caps{CDF} and the ideal.
...
The number next to each bar is the length of this distance:
...
\hline
\end{tabular}
\caption{Error rates for size and interval predictions for all traces.}
\tab{traces}
\end{center}
\vspace{-2em}
\end{table*}
