...
Different aspects of flow behavior can be represented in this way, and those representations can be combined simply by taking the direct sum of their representation vectors.
