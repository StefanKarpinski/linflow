...
\Figure{svd} shows scatter plots of most significant two coordinates when this procedure is applied to a random sample of 5000 flows from each of six unrelated traffic traces.
...
The properties of the model exactly explain the structures seen in \Figure{svd}.
